...
public class GameInventory : MonoBehaviour {
      ...
      //5 Inventory Items: are they collected?
      ...
      public void InventoryAdd(string item){
            ...
            //if (!InvIsOpen){
                 // OpenCloseInventory();         ///  This seems annoying, at least for our game. We can uncomment if needed
           // }
      }
	  ...
	  public void CraftObject1(){
            InventoryAdd("ability1"); // sample inventory item to be added, needs supporting UI images
            InventoryRemove("item1", 1); InventoryRemove("item2",1); // sample inventory items to be removed
      }
	  public void CraftObject2(){
            InventoryAdd("ability2"); // sample inventory item to be added, needs supporting UI images
            InventoryRemove("item3", 1); InventoryRemove("item4",1); // sample inventory items to be removed
      }
	  public void CraftObject3(){
            InventoryAdd("ability3"); // sample inventory item to be added, needs supporting UI images
            InventoryRemove("item1", 1); InventoryRemove("item3",1); // sample inventory items to be removed
      }
	  public void CraftObject4(){
            InventoryAdd("ability4"); // sample inventory item to be added, needs supporting UI images
            InventoryRemove("item1", 1); InventoryRemove("item4",1); // sample inventory items to be removed
      }
	  public void CraftObject5(){
            InventoryAdd("ability5"); // sample inventory item to be added, needs supporting UI images
            InventoryRemove("item2", 1); InventoryRemove("item3",1); // sample inventory items to be removed
      }
	  public void CraftObject6(){
            InventoryAdd("ability6"); // sample inventory item to be added, needs supporting UI images
            InventoryRemove("item2", 1); InventoryRemove("item4",1); // sample inventory items to be removed
      }
